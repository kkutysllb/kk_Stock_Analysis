          ...
          <div v-else class="sector-chart-container">
            ...
            <div class="legend-section">
              <div class="legend-item">
                ...
                <span>{{ selectedSectorInfo?.name || '指数' }}成交量</span>
              </div>
              <div class="legend-item">
...
const initSectorChart = () => {
  ...
  const chart = echarts.init(sectorChart.value)
      ...
      const option = {
        ...
        legend: {
          data: [`${sectorName}成交量`, `${sectorName}涨跌幅`, `${sectorName}成交量变化`],
          top: 30,
          textStyle: {
            color: textColor
          }
        ...
        series: [
          {
            ...
            data: volumeData,
            itemStyle: {
              color: selectedConfig?.color || '#5470c6'
            },
            // 添加动画效果
          ...
          },
          {
            ...
            itemStyle: {
              color: function(params: any) {
                return params.value > 0 ? '#ff4757' : '#2ed573' // 红涨绿跌
              }
            },
            symbol: 'circle',
            symbolSize: 4,
